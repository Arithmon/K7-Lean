...
**Version**: 3.5
**Date**: 2026-09-23
**Proof Systems**: Lean 4 (v4.33.1 + Mathlib v4.33.1)
...
K₇ (formerly GIFT) is the founding framework of the [Arithmon program](https://github.com/arithmon), the hypothesis that the constants of nature are counts.
